...
# ============================================================
# 5. DECISION TREE MODELİ
# ============================================================

# decision tree modelini tanımlıyorum
# max_depth=5 ile ağacın çok derinleşmesini engelliyorum (overfitting önlemi)
...
plt.close()
print("dt_confusion_matrix.png kaydedildi.")
...
feature_importance.plot(kind='bar', color='darkorange')
plt.title('Decision Tree - En Önemli 15 Özellik')
plt.xlabel('Özellik')
...
plt.close()
print("dt_feature_importance.png kaydedildi.")

# ============================================================
# 9. AĞAÇ GÖRSELİ
# ============================================================

# karar ağacını görsel olarak çiziyorum (max 3 derinlik gösteriyorum, okunabilir olsun)
...
plot_tree(dt_model,
          ...
          rounded=True,
          fontsize=8)
plt.title('Decision Tree - Karar Ağacı Görseli')
plt.tight_layout()
plt.savefig('dt_agac_gorseli.png', dpi=150)
plt.close()
print("dt_agac_gorseli.png kaydedildi.")
